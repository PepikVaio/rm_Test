[![it](https://img.shields.io/badge/lang-en-red.svg) [https://github.com/PepikVaio/reMarkable_Xovi_Extensions)
...
[[sostenuto: rM1] [https://img.shields.io/badge/rM1-supported-green] [https://remarkable.com/store/remarkable)
[[sostenuto: rM2] [https://img.shields.io/badge/rM2-supported-green) [https://remarkable.com/store/remarkable-2)
[[sostenuto: rmPP]-[https://img.shields.io/badge/rmPP-supported-blue) [https://remarkable.com/store/remarkable-paper/pro)
[[sostenuto: FW] [https://img.shields.io/badge/fw_3.xx-supported-green) []
...
## Installazione
`.qmd`, `.rcc` e i file `.json` (se disponibili) copiano in `/home/root/xovi/exthome/qt-resource-rebuilder`.
...
* [sidebar_Clock](https://github.com/PepikVaio/reMarkable_Xovi_Extensions/tree/main/sidebar_Clock) - Incredibile orologio nella barra laterale riMarkable (è possibile aggiungere vacanze, giorni speciali e tempo).
* [sidebar_Tradotto](https://github.com/PepikVaio/reMarkable_Xovi_Extensions/tree/main/sidebar_Translated) - Traduzione parziale del sidebar in ceco. Una versione migliorata sarà presto disponibile.
...
* [system_Translation](https://github.com/PepikVaio/reMarkable_Xovi_Extensions/tree/main/system_Translation) - Un piccolo incantesimo e il tuo riMarkable su di te parlerà ceco.

* [toolbar_Expand_Typing](https://github.com/PepikVaio/reMarkable_Xovi_Extensions/tree/main/toolbar_Expand_Typing) - Espande la selezione degli strumenti durante la scrittura.

* [xovi_Settings_Example](https://github.com/PepikVaio/reMarkable_Xovi_Extensions/tree/main/xovi_Settings_Example) - Esempio di impostazione personalizzata per estendere il `xovi_Settings_Main`.
...
> - [readme - multilingua] [https://github.com/jonatasemidio/multilanguage-readme-pattern)
> - [readme - icone](https://shields.io/)