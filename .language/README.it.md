...
# MARCDOWN_PLACEHOLDER_0 extension!
...
## Installazione
I file `.qmd`, `.rcc` e `.json` (se disponibile) copiano in `/home/root/xovi/exthome/qt-resource-rebuilder`.
...
* [sidebar_Clock](https://github.com/PepikVaio/reMarkable_Xovi_Extensions/tree/main/sidebar_Clock) - Impressionante orologio nel sidebar riMarkable (è possibile aggiungere vacanze, giorni speciali e tempo).
...
* [xovi_Settings_Example](https://github.com/PepikVaio/reMarkable_Xovi_Extensions/tree/main/xovi_Settings_Example) - Esempio di impostazione personalizzata per estendere `xovi_Settings_Main`.
